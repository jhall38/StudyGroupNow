...
class UserInfo(models.Model):
	...
	bio = models.CharField(max_length=500, default="I haven't filled out this section yet", blank=True, error_messages={'max_length': 'Your about section is too long! Please do not exceed 500 characters'})
	...
	major = models.CharField(max_length=50, default="I haven't filled out this section yet", blank=True, error_messages = {'max_length': 'The major you entered is invalid! Please enter a major that does not exceed 50 characters'})	
	minor = models.CharField(max_length=50, default="I haven't filled out this section yet", blank=True, error_messages = {'max_length': 'The minor you entered is invalid! Please enter a major that does not exceed 50 characters'})	
	ideal_study_group = models.CharField(max_length=1000, default="I haven't filled out this section yet", blank=True, error_messages = {'max_length': 'The ideal study group section is too long! Please do not exceed 1000 characters.'})
